...
#pragma mark - Clicks
// content is NSDictionary<NSString, id>
RCT_EXTERN_METHOD(logClickToLikeContent:(nullable NSDictionary *)content
...
// content is NSDictionary<NSString, id>
RCT_EXTERN_METHOD(logClickWithActionName:(NSString *)action
                  content:(nullable NSDictionary *)properties)
...
RCT_EXTERN_METHOD(collectionViewDidLoad:(NSArray *)items
